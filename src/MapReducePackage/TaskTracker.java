...
public class TaskTracker {
	// TODO config
	// JT_IP,port,heartbeatTimeInterval,TT_ID,blockSize,HDFS_NN_IP,dataNodeDir
	...
	protected void sendHeartBeat() throws RemoteException {
		...
		HeartBeatRequest heartBeatRequest = new HeartBeatRequest(TT_ID, numMapSlotsFree, numReduceSlotsFree, mapStatus,
				reduceStatus);
